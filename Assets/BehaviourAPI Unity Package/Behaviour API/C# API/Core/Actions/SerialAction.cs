...
namespace BehaviourAPI.Core.Actions
{
    ...
    /// </summary>
    public class SerialAction : CompoundAction
    {
        /// <summary>
        ...
        public SerialAction(Status targetStatus, List<Action> subActions) : base(subActions)
        {
            TargetStatus = targetStatus;
        }

        public SerialAction() : base()
        {
            TargetStatus = Status.Success;
        }

        public SerialAction(Status targetStatus, params Action[] subActions) : base(subActions)
        {
            TargetStatus = targetStatus;
        }
